package com.example.bnsp_beningsukma;
...
public class DetailUang extends AppCompatActivity {
    String[] listCashFlow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Custom adapter = new Custom(this,R.layout.inputdata,modelArrayList);
        listCashflowView.setAdapter(adapter);

        backToMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent loginIntent = new Intent(DetailUang.this, MainActivity.class);
